...
kable(Assocs(contigency_table), format = "pipe", align = "c", col.names = c("Metric", "estimate", "lwe.ci", "upr.ci"))
...
kable(contigency_table_france, format = "pipe", align = "c", col.names = c("Athletes' Country", "Host Country", "Number of Medals"))
